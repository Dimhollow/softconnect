...
pub const LINK_DOCS_HOME: &str = "https://soft1.ch/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://soft1.ch/";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["remote.soft1.ch"];
pub const RS_PUB_KEY: &str = "5feZEqWpnFlRUOk03vIG69cyrnkKXrgVsiNCMBAPnng=";
